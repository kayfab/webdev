    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="mt">
            <a class="active" href="upload.html">
          ...
          <div class="row mt">
            <div class="col-lg-12">
              ...
              <div class="form-panel">
                <div class="form">
                  <form class="cmxform form-horizontal style-form" name="uploadform" method="POST" action="upload3.php">
                    ...
                    <div class="form-group">
                      <div class="col-lg-offset-2 col-lg-10">
                        <button class="btn btn-theme" name="uplaod" value="upload" type="submit">Upload</button>
  ...
  <script type="text/javascript">
    $(document).ready(function() {
      var unique_id = $.gritter.add({
        ...
        title: 'Welcome to Lets talk dashboard!',
        // (string | mandatory) the text inside the notification
        text: 'Here you can upload your videos update or delete.',
