  ...
  <section id="container">
    ...
    <section id="main-content">
        <section class="wrapper">
          ...
          <h4 class="text-info">Details <i class="fa fa-edit"></i></h4>
                <form method="POST" action="" name="form" style="width:100%;">
                <div class="form-group">  
                    Id:<input type="text" name="id" class="form-control" value="<?php echo $id;?>">
                </div> 
                <div class="form-group">  
                    Name:<input type="text" name="name" class="form-control" value="<?php echo $name;?>" >
                </div>  
                <div class="form-group">
                    Description:<input type="text" class="form-control" name="description" value="<?php echo $des;?>">                </div> 
                <div class="form-group">
                    Video:<input type="text" class="form-control" name="video" value="<?php echo $vid;?>">            
                </div> 
